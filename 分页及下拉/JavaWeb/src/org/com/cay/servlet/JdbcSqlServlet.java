...
import org.com.cay.service.impl.JdbcCostServiceImpl;
import org.com.cay.util.StringUtil;

/**
 * Servlet implementation class SublistServlet
 */
@WebServlet(urlPatterns = "/JdbcSqlServlet")
public class JdbcSqlServlet extends HttpServlet {       
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CostService costService = new JdbcCostServiceImpl();
		//接收request参数
		...
		if(pageNumStr != null && !StringUtil.isNum(pageNumStr)){
			...
			request.getRequestDispatcher("jdbcSqlCost.jsp").forward(request, response);
			return;
		}
